...
namespace TabletDriverFilters.Devocub
{
    ...
    public class Antichatter : Interpolator
    {
        ...
        [SliderProperty("Latency", 0f, 1000f, 2f), DefaultPropertyValue(2f), ToolTip
        ...
        [Property("Antichatter Strength"), DefaultPropertyValue(3f), ToolTip
        ...
        [Property("Antichatter Multiplier"), DefaultPropertyValue(1f), ToolTip
        ("Antichatter is meant to prevent cursor chattering/rattling/shaking/trembling when the pen doesn't move.\n" +
        "Antichatter in its primary form is useful for tablets which don't have any hardware smoothing.\n" +
        "Antichatter uses smoothing. Latency and Frequency values do have an effect on antichatter settings.\n\n" +
        "Formula for smoothing is:\n" +
        ...
        [Property("Antichatter Offset X"), ToolTip
        ("Antichatter is meant to prevent cursor chattering/rattling/shaking/trembling when the pen doesn't move.\n" +
        "Antichatter in its primary form is useful for tablets which don't have any hardware smoothing.\n" +
        "Antichatter uses smoothing. Latency and Frequency values do have an effect on antichatter settings.\n\n" +
        "Formula for smoothing is:\n" +
        ...
        [Property("Antichatter Offset Y"), DefaultPropertyValue(1f), ToolTip
        ("Antichatter is meant to prevent cursor chattering/rattling/shaking/trembling when the pen doesn't move.\n" +
        "Antichatter in its primary form is useful for tablets which don't have any hardware smoothing.\n" +
        "Antichatter uses smoothing. Latency and Frequency values do have an effect on antichatter settings.\n\n" +
        "Formula for smoothing is:\n" +
        ...
        [BooleanProperty("Prediction", ""), ToolTip
        ("Prediction - How it works: It adds a predicted point to smoothing algorithm. It helps to preserve sharpness of movement, help with small movements,\n" +
        ...
        [Property("Prediction Strength"), DefaultPropertyValue(1.1f), ToolTip
        ("Prediction - How it works: It adds a predicted point to smoothing algorithm. It helps to preserve sharpness of movement, help with small movements,\n" +
        "Low values (~10-15ms) of smoothing latency can cause problems for cursor movement. It's very preferred to use at least 10-15ms of smoothing latency, 20-40 ms is even better and recommended.\n" +
        "In sum cursor can even outdistance real position (similar to Wacom 6.3.95 drivers).\n\n" +
        "Formula for prediction is:\n" +
        ...
        [Property("Prediction Sharpness"), DefaultPropertyValue(1f), ToolTip
        ("Prediction - How it works: It adds a predicted point to smoothing algorithm. It helps to preserve sharpness of movement, help with small movements,\n" +
        "Low values (~10-15ms) of smoothing latency can cause problems for cursor movement. It's very preferred to use at least 10-15ms of smoothing latency, 20-40 ms is even better and recommended.\n" +
        "In sum cursor can even outdistance real position (similar to Wacom 6.3.95 drivers).\n\n" +
        "Formula for prediction is:\n" +
        ...
        [Property("Prediction Offset X"), DefaultPropertyValue(3f), ToolTip
        ("Prediction - How it works: It adds a predicted point to smoothing algorithm. It helps to preserve sharpness of movement, help with small movements,\n" +
        "Low values (~10-15ms) of smoothing latency can cause problems for cursor movement. It's very preferred to use at least 10-15ms of smoothing latency, 20-40 ms is even better and recommended.\n" +
        "In sum cursor can even outdistance real position (similar to Wacom 6.3.95 drivers).\n\n" +
        "Formula for prediction is:\n" +
        ...
        [Property("Prediction Offset Y"), DefaultPropertyValue(0.3f), ToolTip
        ("Prediction - How it works: It adds a predicted point to smoothing algorithm. It helps to preserve sharpness of movement, help with small movements,\n" +
        "Low values (~10-15ms) of smoothing latency can cause problems for cursor movement. It's very preferred to use at least 10-15ms of smoothing latency, 20-40 ms is even better and recommended.\n" +
        "In sum cursor can even outdistance real position (similar to Wacom 6.3.95 drivers).\n\n" +
        "Formula for prediction is:\n" +
